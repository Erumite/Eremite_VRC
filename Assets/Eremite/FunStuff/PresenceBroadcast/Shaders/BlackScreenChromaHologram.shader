...
Shader "Eremite/BlackScreenChromaHologram"
{
	Properties
	{
		...
		_HologramStrength("HologramStrength", Range( 0 , 10)) = 1
		_HologramScroll("HologramScroll", Vector) = (-0.02,0,0,0)
		_PixelateUVsXY("PixelateUVsXY", Vector) = (420,69,0,0)
		[Toggle(_BRIGHTEN_ON)] _Brighten("Brighten", Float) = 0
		_Brightness("Brightness", Range( 0 , 1)) = 0.5
		_MinBrightness("MinBrightness", Range( 0 , 1)) = 0.2
	...
	SubShader
	{
		...
		#pragma target 3.0
		#pragma multi_compile __ _BRIGHTEN_ON
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 inputTexture259 = tex2D( _MainTex, uv_MainTex );
			...
			float4 BrightenedChromaContent282 = saturate( ( appendResult276 * ( temp_output_270_0 / ( temp_output_270_0 + (0.0001 + (( 1.0 - _Brightness ) - 0.0) * (0.1 - 0.0001) / (1.0 - 0.0)) ) ) ) );
			...
			if( temp_output_293_0 < _MinBrightness )
				ifLocalVar302 = ( ( _MinBrightness - temp_output_293_0 ) + BrightenedChromaContent282 );
			...
			#endif
			float2 panner286 = ( 1.0 * _Time.y * _HologramScroll + i.uv_texcoord);
			float pixelWidth287 =  1.0f / _PixelateUVsXY.x;
			float pixelHeight287 = 1.0f / _PixelateUVsXY.y;
			half2 pixelateduv287 = half2((int)(panner286.x / pixelWidth287) * pixelWidth287, (int)(panner286.y / pixelHeight287) * pixelHeight287);
			float4 Hologram292 = tex2D( _HologramTex, pixelateduv287 );
			float4 temp_output_316_0 = ( staticSwitch312 * _HologramColor * Hologram292 );
			o.Albedo = temp_output_316_0.rgb;
			o.Emission = temp_output_316_0.rgb;
			int temp_output_315_0 = 0;
			o.Metallic = (float)temp_output_315_0;
			o.Smoothness = (float)temp_output_315_0;
			float4 break301 = ( Hologram292.a * inputTexture259 * _HologramStrength );
...
/*ASEBEGIN
Version=18000
1944;63;1906;924;1755.321;994.6772;1;True;False
Node;AmplifyShaderEditor.SamplerNode;257;-3871.169,-722.9272;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;False;0;-1;b4adb7ccc0da0c04f9373f72160a7f2a;b4adb7ccc0da0c04f9373f72160a7f2a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;260;-3285.732,-429.1129;Float;False;Property;_Brightness;Brightness;7;0;Create;True;0;0;False;0;0.5;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;267;-2974.543,-269.356;Inherit;False;Constant;_BrightnessMax;BrightnessMax;10;0;Create;True;0;0;False;0;0.1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;264;-2972.543,-339.3558;Inherit;False;Constant;_BrightnessMin;BrightnessMin;10;0;Create;True;0;0;False;0;0.0001;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;283;-1535.659,-1401.082;Float;False;Property;_HologramScroll;HologramScroll;4;0;Create;True;0;0;False;0;-0.02,0;-0.02,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;285;-1533.649,-1278.077;Float;False;Property;_PixelateUVsXY;PixelateUVsXY;5;0;Create;True;0;0;False;0;420,69;420,69;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TFHCPixelate;287;-1119.658,-1423.081;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT;1024;False;2;FLOAT;1024;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;290;-902.8055,-1478.325;Inherit;True;Property;_HologramTex;HologramTex;1;0;Create;True;0;0;False;0;-1;bfe4769db15cb2940b1d758cc8406bc4;bfe4769db15cb2940b1d758cc8406bc4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;291;-3016.052,-1564.653;Inherit;False;Property;_MinBrightness;MinBrightness;8;0;Create;True;0;0;False;0;0.2;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;297;-212.4628,-1234.937;Inherit;False;Property;_HologramStrength;HologramStrength;3;0;Create;True;0;0;False;0;1;1;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;311;-873.9459,-579.1421;Float;False;Property;_HologramColor;HologramColor;2;0;Create;True;0;0;False;0;1,1,1,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;312;-877.6495,-697.4783;Inherit;False;Property;_Brighten;Brighten;6;0;Create;True;0;0;False;0;1;0;1;True;;Toggle;2;Key0;Key1;Create;False;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.IntNode;315;-274.6025,-465.3536;Inherit;False;Constant;_Int0;Int 0;8;0;Create;True;0;0;False;0;0;0;0;1;INT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-44.6086,-639.0496;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;Eremite/BlackScreenChromaHologram;False;False;False;False;True;True;True;True;True;True;True;True;False;False;True;False;False;False;False;False;False;Back;1;False;-1;3;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;0.5;True;False;0;False;Transparent;;Transparent;ForwardOnly;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;2;5;False;-1;10;False;-1;1;5;False;-1;5;False;-1;1;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexScale;True;False;Cylindrical;False;Relative;0;Standard;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;True;-1;0;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;0;3;315;0
WireConnection;0;4;315;0
WireConnection;0;9;317;0
ASEEND*/
//CHKSM=61519DAC5AA33CAA4230EEB0158579EDFFAB9180