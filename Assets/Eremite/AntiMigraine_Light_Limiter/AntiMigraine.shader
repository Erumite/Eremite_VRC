...
////// Lighting:
                ...
                float3 finalColor = (float4(float3(float2(FinalRed,FinalGreen),FinalBlue),SceneAlpha)*(node_3408/max((node_3408+(_Sensitivity*-0.099+0.1)),superlowvalue))*_HueMod.rgb*_BrightnessMod).rgb;
