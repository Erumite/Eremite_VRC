...
////// Emissive:
                ...
                float node_300 = 0.0;
                float node_230 = (saturate(pow((_OutBlack + ( (dot(lerp(tex2D( _GrabTexture, ScreenPosUV).rgb,(1.0 - Blur),0.5),float3(0.3,0.59,0.11)) - node_300) * (_OutWhite - _OutBlack) ) / (1.0 - node_300)),_Sharp))*-1.0+1.0);
                float3 emissive = float3(node_230,node_230,node_230);
